...
async function main() {
  ...
  const initialSupplyTo   = new Address("0:30f83620a1cf2328a872dcd7eb309866710a4718258e0eff409889c27969ef3e")
  // Address of token owner (write your own)
  const rootOwner         = new Address("0:30f83620a1cf2328a872dcd7eb309866710a4718258e0eff409889c27969ef3e")
  // Name of the token     
  const name              = "Luniar"
  // Symbol of the token
  const symbol            = "LNAR"
